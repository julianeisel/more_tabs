...
static void rna_uiItemTabsR(uiLayout *layout, PointerRNA *ptr, const char *propname, const char *name, const char *text_ctxt,
                            int translate, int icon, int alignment, int icon_only, int separate)
{
	PropertyRNA *prop = RNA_struct_find_property(ptr, propname);
	...
	uiItemTabsR(layout, ptr, prop, name, icon, alignment, icon_only, separate);
}
...
void RNA_api_ui_layout(StructRNA *srna)
{
	...
	RNA_def_boolean(func, "separate", true, "", "Seperate tabs with some whitespace");
